...
- 直接打印 class,发现类实际是个函数，就是对应的构造函数，this 关键字代表实例对象,简单的说是 class 就是构造函数，prototype 对象的 constructor 属性，直接指向“类”的本身。
...
java 中的继承 http://www.runoob.com/java/java-inheritance.html
