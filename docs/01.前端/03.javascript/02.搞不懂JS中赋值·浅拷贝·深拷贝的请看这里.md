...
```javascript
let target = {};
let source = { a: 'koala', b: { name: '前端程序员成长指北' } };
Object.assign(target, source);
console.log(target); // { a: 'koala', b: { name: '前端程序员成长指北' } }
source.a = 'smallKoala';
source.b.name = '前端程序员成长指北哦';
console.log(source); // { a: 'smallKoala', b: { name: '前端程序员成长指北哦' } }
console.log(target); // { a: 'koala', b: { name: '前端程序员成长指北哦' } }
```
