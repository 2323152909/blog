...
console.log(path.normalize('/koala/Desktop//前端程序员成长指北//代码pra/..'));
```

**规范后的结果**

```javascript
/koala/Desktop/前端程序员成长指北/代码pra
```
**作用总结**
...
```javascript
{ root: '/',
  dir: '/koala/Desktop/前端程序员成长指北/代码pra',
  base: 'node核心API',
  ext: '',
  name: 'node核心API' 
}
...
../../impl/bbb
 ""
 ../../koala/Desktop/前端程序员成长指北/代码pra/node核心API
```
**作用总结**
