...
```
drwxr-xr-x 1 coderlhd 197121 0 Jun 28 14:41 core
-rw-r--r-- 1 coderlhd 197121 293 Jun 23 17:44 index.md
```
...
const filePath = path.join(__dirname, 'coderlhdFile.txt');
const filePath1 = path.join(__dirname, 'coderlhdFile1.txt');
// -- 异步读取文件
